...
//     responseType: 'json' // 返回数据的格式，可选值为arraybuffer,blob,document,json,text,stream，默认值为json
// })
//
...
// }
// // 商机管理系统菜单接口
// export const animtedJson=()=> {
//     return getAxios('get', 'https://antv.alipay.com/assets/data/f2/animted-line.json').then(res => res.data)
// }